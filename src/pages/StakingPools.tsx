...
const tiers = [
  ...
  },
  {
    ...
    points: 11150,
    color: 'from-primary-dark via-accent to-primary'
  },
  {
    name: 'Gold',
    requirement: '150,000 KPAD',
    points: 3850,
    color: 'from-accent via-primary to-accent-dark'
  },
  {
    name: 'Silver',
    requirement: '40,000 KPAD',
    points: 950,
    color: 'from-primary via-primary-dark to-accent'
  },
  {
    name: 'Bronze',
    requirement: '10,000 KPAD',
    points: 200,
    color: 'from-accent-dark via-primary to-primary-dark'
  }
];
